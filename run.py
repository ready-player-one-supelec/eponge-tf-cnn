...
names = [f'data/CNN-batchsize{s}' for s in batches_size]
multi_runs_mnist(1, 1, names, CNN_factory, batches_size=batches_size, metrics=[
                 ('sample', 'error_rate'), ('sample', 'time')])
